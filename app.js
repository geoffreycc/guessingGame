      ...
      if (answerOne === "yes"){//compares the user input to the string yes.
        alert("Great job " + userName + "!");//If the above statement is true this string will be displayed.
      }else if (answerOne === "no"){//compares the user input to the string no.
      ...
      if (answerTwo === "no"){//compares the user input to no
        alert("That is correct " + userName + ".");//if the above statement is true this string will display.
      }else if (answerTwo === "yes"){//compares the user input to yes.
      ...
      if (answerThree === "yes"){//compares the user input to yes.
        alert("That's right " + userName + " it sure is.");//if the above is true this string will display.
      }else if (answerThree === "no"){//compares the user input to no.
